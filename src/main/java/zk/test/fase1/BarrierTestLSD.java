...
import zk.test.fase1.SyncPrimitive.Barrier;
import zk.test.fase1.SyncPrimitive.Queue;
...
public class BarrierTestLSD {
    ...
    public static void queueTest(String args[]) {
        ...
        System.out.println("Input: " + args[1]); //localhost
        int i;
        Integer max = new Integer(args[2]); //100
